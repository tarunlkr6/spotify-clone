        ...
        >
          ...
          <div className="nav-btn">
            {localStorage.getItem('loggedin') ? (
              <>
                <a href="#">Tarun <strong>Kumar</strong></a>
            ...
            <Modal show={show} onHide={handleClose}>
              ...
              <Modal.Body>
                <p>
                  email: <strong>tarun@example.com</strong>{" "}
                </p>
                <p>
                  pwd: <strong>tarunlkr6</strong>
                </p>
                <Form>
            ...
            <br />
            <a href="https://github.com/tarunlkr6/spotify-clone.git" target='_blank'><span className="copyleft">&copy;</span> tarunlkr6</a>
          </div>
        </nav>
      </div>
    </div>
